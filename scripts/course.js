...
const courseContainer = document.querySelector('.courseNames ul');
const filterButtons = document.querySelectorAll('.somebtns a');
const totalCreditsEl = document.createElement('p');
document.querySelector('.card h2').after(totalCreditsEl);
...
function displayCourses(filteredCourses) {
    ...
    filteredCourses.forEach(course => {
        ...
        // Add completed or not-completed class for styling
        if (course.completed) {
